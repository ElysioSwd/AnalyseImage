% Charger l'image
image = imread('barbara.png'); % Remplacez 'votre_image.jpg' par le chemin de votre image
...
filter_x = [-1 0 1; -2 0 2; -1 0 1]; % Filtre de Sobel horizontal
filter_y = [-1 -2 -1; 0 0 0; 1 2 1]; % Filtre de Sobel vertical
